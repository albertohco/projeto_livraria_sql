...
class LivroService:
    ...
    def listar(self):
        ...
        try:
            ...
            for livro in livros:
                print(f'Id: {livro.id} | Título: {livro.titulo} | Isbn: {livro.isbn} | Páginas: {str(livro.paginas)} | Ano: {str(livro.ano)} | Resumo: {livro.resumo} | Categoria: {livro.categoria.nome} | Editora: {livro.editora.nome} | Autor: {livro.autor.nome} ')
    ...
    def adicionar(self):
        ...
        try:
            ...
            novo_livro = Livro(titulo, isbn, paginas, ano,
                               resumo, categoria, editora, autor)
    ...
    def mostrar_por_id(self):
        ...
        try:
            ...
            if (liv == None):
                ...
                print(f'Id: {liv.id} | Título: {liv.titulo} | Isbn: {liv.isbn} | Ano: {str(liv.ano)} | Páginas: {str(liv.paginas)} | Resumo: {liv.resumo} | Categoria: {liv.categoria.nome}  | Editora: {liv.editora.nome}  | Autor: {liv.autor.nome}')
        except Exception as e:
