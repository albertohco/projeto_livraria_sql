...
class EditoraService:
    ...
    def listar(self):
        ...
        try:
            ...
            for editora in editoras:
                print(
                    f'{editora.id} | {editora.nome} | {editora.endereco} | {editora.telefone}')
    ...
    def inserir_csv(self):
        ...
        try:
            nome_arquivo = input(
                'Digite o nome do arquivo CSV (Precisa estar na raiz do projeto): ')
            lista_dict_editoras = editoras_csv.ler_csv_e_gera_uma_lista_de_editoras(
                nome_arquivo)
    ...
    def exportar_csv(self):
        ...
        try:
            nome_arquivo = input(
                'Digite o nome do arquivo CSV que será criado na pasta raiz do projeto: ')
            lista_de_editoras = self.__editora_dao.listar()
            editoras_csv.criando_csv_usando_lista_de_editoras(
                lista_de_editoras, nome_arquivo)
    ...
    def inserir_json(self):
        ...
        try:
            nome_arquivo = input(
                'Digite o nome do arquivo JSON (Precisa estar na raiz do projeto): ')
            lista_dict_editoras = editoras_json.ler_json_e_gera_uma_lista_de_editoras(
                nome_arquivo)
            self.__editora_dao.adicionar_muitos(lista_dict_editoras)
    ...
    def exportar_json(self):
        ...
        try:
            nome_arquivo = input(
                'Digite o nome do arquivo JSON que será criado na pasta raiz do projeto: ')
            lista_de_editoras = self.__editora_dao.listar()
            editoras_json.criando_json_usando_lista_de_editoras(
                lista_de_editoras, nome_arquivo)
